...
# Points for outer and inner mouth regions
...
video_path = '../../../Downloads/final project/Proctoring-AI-master/WIN_20240731_20_11_13_Pro.mp4'
cap = cv2.VideoCapture(video_path)

# Record mouth distances
frame_count = 0
...
d_outer[:] = [x / frame_count for x in d_outer]
d_inner[:] = [x / frame_count for x in d_inner]

# Reset video capture to the beginning
cap.release()
cap = cv2.VideoCapture(video_path)

# Process the video for mouth opening detection
while True:
    ret, img = cap.read()
    if not ret:
        break
